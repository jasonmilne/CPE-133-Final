...
HD_PWD='C:/Users/bothe/Nextcloud/Cal poly/Fall 2020/CPE 133/Vidado/CPE133Labs/CPE133Labs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProject.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FinalProject.tcl -notrace
