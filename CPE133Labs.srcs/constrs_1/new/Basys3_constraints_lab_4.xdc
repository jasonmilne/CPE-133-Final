...
#set_property PACKAGE_PIN W15 [get_ports {B[0]}]	//these are empty to create a break				
...
#set_property PACKAGE_PIN V13 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN V3 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN W3 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN U3 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN P3 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN N3 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
#set_property PACKAGE_PIN P1 [get_ports {neg}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {neg}]
