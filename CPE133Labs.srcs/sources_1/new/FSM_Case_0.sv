...
module FSM_Case_0(
    ...
    logic [3:0] a = 5'b0000;// state 1   //bit 0
    logic [3:0] b = 5'b0001;// state 2   //bit 1
    logic [3:0] c = 5'b0010;// state 3   //bit 2
    logic [3:0] d = 5'b0011;// state 4   //bit 3
    logic [3:0] e = 5'b0100;// state 5   //bit 4
    logic [3:0] f = 5'b0101;// state 6   //bit 5
    logic [3:0] g = 5'b0110;// state 7   //bit 6
    logic [3:0] h = 5'b0111;// state 8   //bit 7
    logic [3:0] i = 5'b1000;// state 9   //bit 8
    logic [3:0] j = 5'b1001;// state 10  //bit 9
    logic [3:0] k = 5'b1010;// state 11  //bit 10
    logic [3:0] l = 5'b1011;// state 12  //bit 11
    logic [3:0] m = 5'b1100;// state 13  //bit 12
    logic [3:0] n = 5'b1101;// state 14  //bit 13
    logic [3:0] o = 5'b1110;// state 15  //bit 14
    logic [3:0] p = 5'b1111;// state 16  //bit 15  
    logic [3:0] FAIL = 5b11111; //this is what the state goes to if the test case fails
